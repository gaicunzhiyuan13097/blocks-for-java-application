package org.firefly.provider.unit.test.matcher;

import org.firefly.provider.unit.test.matcher.ContainMatcher;
...
public class AssertThatTest {
    ...
    public void testAssertThat() {
        ...
        assertThat(Set.of(1, 2, 3), new ContainMatcher<>(2));
    }
}
